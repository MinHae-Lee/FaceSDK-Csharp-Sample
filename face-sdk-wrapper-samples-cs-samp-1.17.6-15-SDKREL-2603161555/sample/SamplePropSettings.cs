...
namespace FaceSDKSample.SampleProp    
{
    ...
    public class Settings : Prop
    {
        ...
        public string SVR_FACESVR_API_URL { get; set; } = "https://stg-face.useb.co.kr"; // "http://192.168.0.217:8081";
        ...
        public string SVR_FACESVR_API_IMG_ENCRYPT_RSA_AES_TS { get; set; } = "25102714072455";
        ...
        public bool UI_ETC_COLOR_HISTOGRAM_SHOW { get; set; } = true;
