...
namespace FaceSDKSample
{
    ...
    {        
        ...
        public void OpenCamera(int cam_index, int cam_width, int cam_height, bool cap_flip_horizontal=false)
        {
            if (cam_ctx_ == null)
                cam_ctx_ = new CamCtx();
            ...
            if (!cam_ctx_.Open(cam_wnd_name, cam_index, cap_flip_horizontal, "ANY", cam_width, cam_height))
            {
                cam_ctx_.Close();
                throw new SampleException(cam_ctx_.GetLastErrMsg());
            }
        }

        public bool GetCaptureInfo(out int cap_index, out int cap_width, out int cap_height)
        {
            cap_index = 0;
            cap_width = 0;
            cap_height = 0;
            ...
            cap_index = cam_ctx_.capture_index;
            cap_width = cam_ctx_.capture_width;
            cap_height = cam_ctx_.capture_height;

            return true;
        }


        public bool GetCameraWidthHeight(out int cam_index, out int cam_width, out int cam_height)
        {
            cam_index = 0;
            cam_width = 0;
            cam_height = 0;
            ...
            cam_index = cam_ctx_.capture_index;

            cam_width = cam_ctx_.capture_width;
            cam_height = cam_ctx_.capture_height;
